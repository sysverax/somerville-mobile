...
export const mockCategories: Category[] = [
  ...
  // Samsung
  { id: 'c5', brandId: 'b2', name: 'Galaxy S', image: '/mock-images/categories/galaxy-s.png', description: 'Samsung Galaxy S flagship phones', isActive: true, createdAt: '2024-01-16' },
  { id: 'c6', brandId: 'b2', name: 'Galaxy Z (Foldables)', image: '/mock-images/categories/galaxy-z.png', description: 'Samsung Galaxy foldable devices', isActive: true, createdAt: '2024-01-16' },
  { id: 'c7', brandId: 'b2', name: 'Galaxy Tab', image: '/mock-images/categories/galaxy-tab.png', description: 'Samsung Galaxy tablets', isActive: true, createdAt: '2024-01-16' },
  { id: 'c8', brandId: 'b2', name: 'Galaxy Watch', image: '/mock-images/categories/galaxy-watch.png', description: 'Samsung Galaxy smartwatches', isActive: true, createdAt: '2024-01-16' },
  // Google
  { id: 'c9', brandId: 'b3', name: 'Pixel Phone', image: '/mock-images/categories/pixel-phone.png', description: 'Google Pixel smartphones', isActive: true, createdAt: '2024-02-02' },
  { id: 'c10', brandId: 'b3', name: 'Pixel Tablet', image: '/mock-images/default/placeholder.png', description: 'Google Pixel tablets', isActive: true, createdAt: '2024-02-02' },
  { id: 'c11', brandId: 'b3', name: 'Pixel Watch', image: '/mock-images/categories/pixel-watch.png', description: 'Google Pixel smartwatches', isActive: true, createdAt: '2024-02-02' },
  // Gaming Console
  { id: 'c12', brandId: 'b4', name: 'Xbox', image: '/mock-images/categories/xbox.png', description: 'Microsoft Xbox consoles', isActive: true, createdAt: '2024-02-10' },
  { id: 'c13', brandId: 'b4', name: 'PlayStation', image: '/mock-images/categories/playstation.png', description: 'Sony PlayStation consoles', isActive: true, createdAt: '2024-02-10' },
  // OnePlus
