...
export const mockBrands: Brand[] = [
  { id: 'b1', name: 'Apple', iconImage: '/mock-images/brands/apple.png', description: 'Apple Inc. – iPhones, iPads, MacBooks & Apple Watch', isActive: true, createdAt: '2024-01-15' },
  { id: 'b2', name: 'Samsung', iconImage: '/mock-images/brands/samsung.png', description: 'Samsung Electronics – Galaxy phones, tablets & wearables', isActive: true, createdAt: '2024-01-15' },
  { id: 'b3', name: 'Google', iconImage: '/mock-images/brands/google.png', description: 'Google – Pixel phones, tablets & watches', isActive: true, createdAt: '2024-02-01' },
  { id: 'b4', name: 'Gaming Console', iconImage: '/mock-images/brands/gaming-console.png', description: 'Gaming consoles – Xbox & PlayStation', isActive: true, createdAt: '2024-02-10' },
  { id: 'b5', name: 'OnePlus', iconImage: '/mock-images/brands/oneplus.png', description: 'OnePlus – Number Series & Nord smartphones', isActive: true, createdAt: '2024-03-01' },
];