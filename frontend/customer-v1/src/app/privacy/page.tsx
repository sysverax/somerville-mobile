              ...
              <section className="border-t border-border pt-8">
                ...
                <div className="grid sm:grid-cols-3 gap-4 items-start">
                  <div className="flex items-center gap-3 text-muted-foreground">
                    ...
                    <span className="text-sm">{process.env.NEXT_PUBLIC_SHOP_EMAIL}</span>
                  </div>
                  <div className="flex items-center gap-3 text-muted-foreground justify-center ml-0 md:ml-[30px]">
                    <Phone className="h-5 w-5 text-primary" />
                    <span className="text-sm">{process.env.NEXT_PUBLIC_SHOP_PHONE}</span>
                  </div>
                  <div className="flex items-start gap-3 text-muted-foreground justify-self-end">
                    <MapPin className="h-5 w-5 text-primary mt-0.5" />
                    <span className="text-sm">{process.env.NEXT_PUBLIC_SHOP_ADDRESS}</span>
                  </div>
                </div>
              </section>
