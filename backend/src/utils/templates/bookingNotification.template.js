          ...
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td style="text-align:right;vertical-align:middle;">
                <div style="font-size:12px;letter-spacing:0.8px;text-transform:uppercase;color:#ffd6d6;">Booking Alert</div>
              </td>
            </tr>
          </table>
          <h1 style="margin:16px 0 0;font-size:24px;line-height:1.25;font-weight:800;">${escapeHtml(heading)}</h1>
          <p style="margin:8px 0 0;font-size:14px;line-height:1.6;color:#f5e9e9;">A customer submitted a booking request from your storefront.</p>
        </td>
      </tr>
      <tr>
